RegisterNetEvent('jonny-anticheat:hash')
AddEventHandler('jonny-anticheat:hash', function()
            count = -0.2
...
RegisterNetEvent('jonny-anticheat:antiPed')
AddEventHandler('jonny-anticheat:antiPed', function()
...
RegisterNetEvent('jonny-anticheat:AntiVehicle')
AddEventHandler('jonny-anticheat:AntiVehicle', function()
...
RegisterNetEvent('jonny-anticheat:antiProp')
AddEventHandler('jonny-anticheat:antiProp', function()
	...
	while true do
		...
		if blacklisted then
            ...
            if Config.AntiWeaponLog then
                TriggerServerEvent('jonny-anticheat:dclog', 'Byebye '..name)
            end
            if Config.AntiWeaponKick then
                TriggerServerEvent('jonny-anticheat:dropplayer')
            end
		end
	end
end)
